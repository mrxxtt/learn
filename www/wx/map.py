...
def render():
    ...
    # 根据城市数据生成地理坐标图
    geo = Geo('好友位置分布', '', title_color='#fff', title_pos='center', width=1500, height=600,
              background_color='#404a59')
    attr, value = geo.cast(data)
    geo.add('', attr, value, visual_range=[0, 50],
...
def handle(cities):
    ...
    data = None
    with open(
            '/anaconda3/lib/python3.7/site-packages/pyecharts/datasets/city_coordinates.json',
